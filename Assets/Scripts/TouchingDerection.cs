...
public class TouchingDerection : MonoBehaviour
{
    ...
    private Vector2 wallCheckDiection => gameObject.transform.localScale.x > 0 ? Vector2.right : Vector2.left;
    ...
    private void FixedUpdate()
    {
        ...
        IsOnWall = (touchingCollider.Cast(wallCheckDiection, castFilter, wallHits, wallDistance) > 0);
